                        ...
                        <table id="example3" class="table table-bordered table-hover" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr id="row-<?php echo e($supplier->id); ?>">
                                    <td class="text-main-8 font-weight-bold"><?php echo e($supplier->supplier_name); ?></td>
                                    <td class="text-main-8 font-weight-bold"><?php echo e($supplier->contact_person); ?></td>
                                    <td class="text-main-8 font-weight-bold"><?php echo e($supplier->contact_number); ?></td>
                                    <td class="text-main-8 font-weight-bold"><?php echo e($supplier->email); ?></td>
                                    <td class="text-main-1 font-weight-bold">₱<?php echo e(number_format($supplier->amount_payable, 2)); ?></td>
                                    <td class="text-main-8 font-weight-bold"><?php echo e($supplier->address); ?></td>
