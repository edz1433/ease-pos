            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <ol class="breadcrumb m-0 p-0" style="background: none; font-size: 11px;">
                        ...
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(route('purchaseRead')); ?>">Purchases</a>
                        </li>
                        <li class="breadcrumb-item active">Form</li>
                    </ol>
                </div>
            
                <?php if(empty($purchasecheck)): ?>
                <div class="card-body">
                    <div class="row">
                ...
                <?php else: ?> 
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('purchaseStoreItem')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                    ...
                                    <select class="form-control select2" name="product_id" id="product_id" required>
                                        ...
                                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <option
                                                ...
                                                data-type="Retail"
                                                data-price="<?php echo e($product->r_capital); ?>"
                                                data-selling-price="<?php echo e($product->r_price); ?>"
                                            >
                                                <?php echo e($product->barcode); ?> - <?php echo e($product->product_name); ?> - 
                                                <?php echo e(number_format($product->r_capital, 2)); ?> (Retail)
                                            </option>

                                            
                                            <?php if($product->packaging > 1): ?>
                                                <option
                                                    value="<?php echo e($product->id); ?>"
                                                    data-product-id="<?php echo e($product->id); ?>"
                                                    data-name="<?php echo e($product->product_name); ?>"
                                                    data-type="Wholesale"
                                                    data-price="<?php echo e($product->w_capital); ?>"
                                                    data-selling-price="<?php echo e($product->w_price); ?>"
                                                >
                                                    <?php echo e($product->barcode); ?> - <?php echo e($product->product_name); ?> - 
                                                    <?php echo e(number_format($product->w_capital, 2)); ?> (Wholesale)
                                                </option>
                                            <?php endif; ?>
                                ...
                                <div class="col-2">
                                    ...
                                    <input type="hidden" name="purchase_id" value="<?php echo e($purchasecheck->id); ?>">
                        ...
                        <div class="d-flex justify-content-end mt-3 mb-2">
                            <button type="button" class="btn btn-outline-danger me-2 mr-1 cancel-btn" data-id="<?php echo e($purchasecheck->id); ?>">
...
<div class="modal fade" id="createPurchaseModal" role="dialog" aria-labelledby="createPurchaseModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <!-- Form -->
            <form method="POST" action="<?php echo e(route('purchaseCreate')); ?>">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <!-- Purchase Date -->
                    <div class="form-group">
                        <label for="transaction_no">Transaction Number</label>
                        <input type="text" class="form-control" id="transaction_no" name="transaction_no" value="<?php echo e($transactionNo); ?>" readonly>
                    </div>
                    <!-- Supplier -->
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="purchase_date" name="purchase_date" 
                            value="<?php echo e($today); ?>" required>
                    </div>
...
<?php if(!empty($purchasecheck)): ?>
    ...
    <div class="modal fade" id="savePurchaseModal" tabindex="-1" role="dialog" aria-labelledby="savePurchaseModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <form id="purchaseForm" action="<?php echo e(route('purchasesSave', $purchasecheck->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="purchase_date">Purchase Date</label>
                            <input type="date" name="purchase_date" id="purchase_date" class="form-control" value="<?php echo e($purchasecheck->purchase_date ?? ''); ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="transaction_no" id="transaction_no" class="form-control" value="<?php echo e($purchasecheck->transaction_no ?? ''); ?>" readonly>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="supplier_id" id="supplier_id" class="form-control" required readonly>
                                <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(($purchasecheck->supplier_id == $supp->id)): ?>
                                        <option value="<?php echo e($supp->id); ?>" selected><?php echo e($supp->supplier_name); ?></option>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="po_number" id="po_number" class="form-control" value="<?php echo e($purchasecheck->po_number ?? ''); ?>" required>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\ease-pos\resources\views/admin/purchases/form.blade.php ENDPATH**/ ?>