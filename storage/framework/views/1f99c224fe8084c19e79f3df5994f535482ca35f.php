...
<aside class="custom-sidebar">
    <div class="custom-sidebar-logo" style="margin-bottom: 10px;">
        <img src="<?php echo e(asset('template/img/logo.png')); ?>" alt="Logo" style="width:40px; height:40px;">
    </div>
    <ul class="custom-sidebar-menu">
        <li>
            <a href="<?php echo e(route('dashboard')); ?>" class="custom-sidebar-link <?php echo e(request()->is('pos') ? 'active' : ''); ?>">
...
<?php /**PATH C:\xampp\htdocs\ease-pos\resources\views/partials/control-cashier.blade.php ENDPATH**/ ?>