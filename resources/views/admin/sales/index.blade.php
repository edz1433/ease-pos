                        ...
                        <div class="table-responsive">
                            <table id="salesTable" class="table table-bordered table-hover table-striped table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-main-8 font-weight-bold">{{ \Carbon\Carbon::parse($sale->date)->format('Y-m-d') }}</td>
                                        <td class="text-main-8 font-weight-bold">{{ $sale->transaction_number }}</td>
                                        <td class="text-main-8 font-weight-bold">{{ $sale->customer ?? 'N/A' }}</td>
                                        <td class="text-main-1">₱{{ number_format($sale->total, 2) }}</td>
                                        <td class="text-main-1">₱{{ number_format($sale->vat, 2) }}</td>
                                        <td class="text-main-1">₱{{ number_format($sale->discount, 2) }}</td>
                                        ...
                                        <td class="text-main-8 font-weight-bold">{{ $sale->full_name ?? '' }}</td>
                                        <td class="text-center">
                                            <button class="btn btn-info btn-sm" data-id="{{ $sale->id }}" title="View Details">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-4">
                                <div class="total-display">
                                    ...
                                    <span class="text-main-1 font-weight-bold" id="totalSales">₱{{ number_format($sales->sum('total'), 2) }}</span>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="total-display">
                                    <span class="text-main-8 font-weight-bold">Total VAT: </span>
                                    <span class="text-main-1 font-weight-bold" id="totalVat">₱{{ number_format($sales->sum('vat'), 2) }}</span>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="total-display">
                                    <span class="text-main-8 font-weight-bold">Total Discount: </span>
                                    <span class="text-main-1 font-weight-bold" id="totalDiscount">₱{{ number_format($sales->sum('discount'), 2) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
