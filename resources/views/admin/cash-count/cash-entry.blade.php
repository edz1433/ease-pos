                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <form id="cashCountForm" method="POST" action="{{ route('cashCountCreate') }}">
                            @csrf
                            <input type="hidden" name="cashcount_id" id="cashcount-id" value="{{ $cashcounts->id ?? 0 }}">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <input type="number"
                                                    ...
                                                    value="{{ (int)($cashcounts->{'qty_'.str_replace('.','_',$denom)} ?? 0) }}"
                                                    class="form-control form-control-sm text-center">
                                            </td>
                                            <td class="text-end fw-bold align-middle">
                                                ₱<span id="subtotal_{{ str_replace('.','_',$denom) }}">
                                                    {{ number_format((($cashcounts->{'qty_'.str_replace('.','_',$denom)} ?? 0) * $denom), 2) }}
                                                </span>
                                            </td>
                                        </tr>
                                        @endforeach
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-bold align-middle">
                                                <input type="number" 
                                                    name="gcash"
                                                    id="gcash"
                                                    step="0.01"   {{-- ✅ numeric with decimals --}}
                                                    min="0"
                                                    value="{{ $cashcounts->gcash ?? 0 }}"
                                                    class="form-control form-control-sm text-center">
                                            </td>
                                        </tr>
