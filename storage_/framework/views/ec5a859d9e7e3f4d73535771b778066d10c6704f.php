...
function generateBarcode(fieldId) {
    let url = "<?php echo e(route('getNextBarcode', ':id')); ?>".replace(':id', fieldId);
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\ease-pos\resources\views/script/productScript.blade.php ENDPATH**/ ?>